    ...
    static pin_conf_t pin_mapping[] =
        {
            ...
            {SPI2_CH0_CS1, XMC_GPIO_PORT3, 10, XMC_GPIO_MODE_OUTPUT_PUSH_PULL},

            {UART_TX, XMC_GPIO_PORT1, 5, XMC_GPIO_MODE_OUTPUT_PUSH_PULL_ALT2},
            {UART_RX, XMC_GPIO_PORT1, 4, XMC_GPIO_MODE_INPUT_TRISTATE},
