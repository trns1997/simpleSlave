...
static const char acName6000_02[] = "Board status";
...
const _objd SDO6000[] =
    {{0x00, DTYPE_UNSIGNED8, 8, ATYPE_RO, &acNameNOE[0], 0x02, NULL},
     {0x01, DTYPE_UNSIGNED16, 16, ATYPE_RO, &acName6000_01[0], 0, &(input.watchdogCounter)}};
const _objd SDO7000[] =
    {{0x00, DTYPE_UNSIGNED8, 8, ATYPE_RO, &acNameNOE[0], 0x01, NULL},
     {0x01, DTYPE_UNSIGNED16, 16, ATYPE_RW, &acName7000_01[0], 0, &(output.watchdogCounter)}};

const _objd SDO8001[] =
    {{0x00, DTYPE_UNSIGNED8, 8, ATYPE_RO, &acNameNOE[0], 0x01, NULL},
     {0x01, DTYPE_UNSIGNED32, 32, ATYPE_RW, &acName8001_01[0], 0, NULL /*&(Cb.reset_counter)*/}};
...
const _objectlist SDOobjects[] =
    {{0x1000, OTYPE_VAR, 0, 0, &acName1000[0], &SDO1000[0]},
     ...
     {0x1A00, OTYPE_RECORD, 0x01, 0, &acName1A00[0], &SDO1A00[0]},
     ...
     {0x6000, OTYPE_ARRAY, 0x01, 0, &acName6000[0], &SDO6000[0]},
